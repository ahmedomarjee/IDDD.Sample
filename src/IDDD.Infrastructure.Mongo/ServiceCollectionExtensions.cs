    ...
    public static class MongoDomainPersistanceExtensions
    {
        ...
        public static IServiceCollection AddMongoDomainPersistance(this IServiceCollection services, IConfiguration config)
        {
            ...
            services.Scan(scan => scan
                ...
                .WithScopedLifetime()
                .AddClasses(classes => classes.AssignableToAny(typeof(IClientRepository)))
                .AsImplementedInterfaces()
                .WithScopedLifetime()
                .AddClasses(classes => classes.AssignableToAny(typeof(IRefreshTokenFinder)))
                .AsImplementedInterfaces()
                .WithScopedLifetime()
                .AddClasses(classes => classes.AssignableToAny(typeof(IRefreshTokenRepository)))
                 .AsImplementedInterfaces()
                .WithScopedLifetime()
